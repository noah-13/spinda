...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        type=Path,
        default=Path("data/external/chaosnli/chaosNLI_snli.jsonl"),
    ...
    parser.add_argument(
        "--train-output",
        type=Path,
        default=Path("data/processed/chaosnli/chaosNLI_snli_train.jsonl"),
        help="Train output JSONL path",
    )
    parser.add_argument(
        "--dev-output",
        type=Path,
        default=Path("data/processed/chaosnli/chaosNLI_snli_dev.jsonl"),
