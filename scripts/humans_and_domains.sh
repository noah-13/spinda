...
INPUT_DIR="${HUMANS_AND_DOMAINS_INPUT_DIR:-data/external/humans_and_domains}"
SINGLE_TEXT_ROOT="${HUMANS_AND_DOMAINS_SINGLE_TEXT_OUTPUT_ROOT:-data/processed/single_text}"
